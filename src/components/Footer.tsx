...
export function Footer() {
  const { t } = useLanguage()
  const directions = [
    t('Moliya & Corporate finance', 'Finance & Corporate Finance'),
    t('Bank ishi & Risk management', 'Banking & Risk Management'),
    'IFRS',
    t('Compliance & AML', 'Compliance & AML'),
    'Data Analytics & Power BI',
    t('AI vositalari', 'AI Tools'),
    'Marketing & PR',
            ...
            <div>
              ...
              <p className="text-background/70 leading-relaxed mb-6">
                {t(
                  ...
                  'Modern professional education for corporate teams. Practical training for banks, companies and institutions.'
                )}
              </p>
            ...
            <div>
              ...
              <p className="text-background/70 text-base mb-8 leading-relaxed">
                {t(
                  ...
                  'Practical corporate training in finance, IFRS, risk management, data analytics, AI tools, marketing, PR and soft skills for banks, companies and institutions.'
                )}
              </p>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-sm text-background/70 mb-4 md:mb-0">
              {t(
                ...
                '© 2025 Fine Skills Academy. All rights reserved.'
              )}
            </div>
            <div className="text-sm text-background/70">
              {t("Toshkent, O'zbekiston", 'Tashkent, Uzbekistan')}
            </div>
          </div>
        </div>
      </div>
